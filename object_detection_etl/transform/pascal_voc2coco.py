...
class PascalVOC2coco(object):
    ...
    def data_transfer(self):
        ...
        for num, json_file in enumerate(self.xml):
            ...
            obj_path = glob.glob(os.path.join(path, 'JPEGImages', '*.png'))
            print('bojpath',obj_path)
            with open(json_file, 'r') as fp:
                for p in fp:
                    ...
                    if 'filename' in p:
                        ...
                        self.path = os.path.join(path, 'JPEGImages', self.filen_ame.split('.')[0] + '.png')
...
path='E:/origin_e/worksparce/pycharm/rider_box_detector2/VOCdevkit2007_1211/VOC2007/Annotations/*.xml'
# path='E:/origin_e/worksparce/pycharm/rider_box_detector2/VOCdevkit2007_1211/VOC2007/Annotations/1-457.xml'
# xml_file = glob.glob('./Annotations/*.xml')
xml_file = glob.glob(path)
