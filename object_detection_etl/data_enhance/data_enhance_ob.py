...
# -*- coding: utf-8 -*-
'''
@Time : 2019/5/13 16:52
@Author :
@Email :
@File : data_enhance_ob.py
@Desc: 
'''
# 包括:
#     1. 裁剪(需改变bbox)
...
def show_pic(img, bboxes=None):
    ...
    for i in range(len(bboxes)):
        ...
        x_max = bbox[2]
        y_max = bbox[3]
        cv2.rectangle(img2, (int(x_min), int(y_min)), (int(x_max), int(y_max)), (0, 255, 0), 3)
...
class DataAugmentForObjectDetection():
    def __init__(self, rotation_rate=0.5, max_rotation_angle=5,
                 ...
                 add_noise_rate=0.5, flip_rate=0.9,
...
if __name__ == '__main__':
    ...
    # source_pic_root_path = args.imagedir
